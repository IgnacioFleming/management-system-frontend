...
export const InputField = ({ input, inputName, inputType = inputTypes.ANY }) => {
  ...
  return <InputText data-testid="input-text" keyfilter={keyfilter} name={inputName} onChange={handleChange} value={inputContent} pt={{ root: { style: { width: inputType === (inputTypes.ANY || inputTypes.DATE) ? "200px" : "100px" } } }} />;
};
