    ...
    <>
      ...
      <div className={styles.container}>
        <div className={styles.formContainer}>
          ...
          <h2>Crear Cuenta</h2>
          <p className="m-0 text-color text-base">Por favor registrá tu nueva cuenta.</p>
          <form id="Register" className={styles.form} onSubmit={handleSubmit}>
            <div className="flex justify-content-center w-full">
              <TextField className="w-8 sm:w-6 justify-self-center" input="username" label="Nombre de Usuario" onChange={handleChange} helperText={errors.username} error={errors.username && true} value={values.username} />
            </div>
            <div className="flex flex-column sm:flex-row justify-content-center align-items-center gap-5 w-full">
              <TextField className="w-8 sm:w-full" input="first_name" label="Nombre" onChange={handleChange} helperText={errors.first_name} error={errors.first_name && true} value={values.first_name} />
              <TextField className="w-8 sm:w-full" input="last_name" label="Apellido" onChange={handleChange} helperText={errors.last_name} error={errors.last_name && true} value={values.last_name} />
            </div>
            ...
            <div className="flex flex-column sm:flex-row justify-content-center gap-5 w-full w-8 sm:w-full">
              ...
              <PasswordInput className="sm:w-full" name="confirm_password" label="Confirmar Contraseña" handleChange={handleChange} invalid={errors.confirm_password} helperText={errors.confirm_password} value={values.confirm_password} />
            </div>
            <Button severity="info" type="submit" label="Crear Cuenta" className="w-4 align-self-center" />
          </form>
